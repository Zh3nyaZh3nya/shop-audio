        ...
        <div class="pb-8">
          ...
          <div class="mb-8">
            ...
            <p>
              ...
              Музыкальная индустрия не стоит на месте и развивается с невероятной скоростью, поэтому начинающим музыкантам,
              творческим людям, а порой и настоящим мастерам сложно выбрать правильный инструмент. Мы – команда профессионалов!
              Постоянно развиваемся и следим за нововведениями! Мы подберем для вас идеальный инструмент, который поможет найти
              идеальное звучание. К нам обращаются люди с разными жанровыми предпочтениями. Кроме того, у нас можно взять в аренду
              профессиональную звуковую и световую технику для проведения мероприятий и концертов.
            </p>
          </div>
          <div class="mb-8">
            ...
            <p>
              ...
              акустические системы, громкоговорители, микрофоны, ударные музыкальные инструменты, клавишные, синтезаторы,
              усилители, генераторы дыма и многое другое.
            </p>
          </div>
          <div class="mb-8">
        ...
        <div>
          ...
          <div class="mb-8">
            ...
            <p>
              ...
              Алматы и другие города Казахстана в указанный срок, а оплату можно произвести в режиме online,
              по карте или безналичным расчетом.
            </p>
          </div>
